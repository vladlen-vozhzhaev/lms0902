...
Page Banner START -->
            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <div class="card bg-transparent border rounded-3">
                        ...
                        <div class="card-body">
                            <!-- Form -->
                            <form class="row g-4" id="avatarForm">
                                @csrf
                                <!-- Profile picture -->
                                <div class="col-12 justify-content-center align-items-center">
                                    <label class="form-label">Аватар пользователя</label>
                                    <div class="d-flex align-items-center">
                                        <label class="position-relative me-4" for="uploadfile-1" title="Replace this pic">
                                            <!-- Avatar place holder -->
                                            <span class="avatar avatar-xl">
											<img id="avatarPreview" class="avatar-img rounded-circle border border-white border-3 shadow" src="{{auth()->user()->img}}" alt="">
										</span>
                                        </label>
                                        <!-- Upload button -->
                                        <label class="btn btn-primary-soft mb-0" for="inputChangeAvatar">Изменить</label>
                                        <input name="userAvatar" id="inputChangeAvatar" class="form-control d-none" type="file">
                                    </div>
                                </div>
                            </form>
                            <form class="row g-4">
    ...
    Page content END -->
    <script>
        const inputChangeAvatar = document.getElementById('inputChangeAvatar');
        const avatarPreview = document.getElementById('avatarPreview');
        const avatarForm = document.getElementById('avatarForm');
        inputChangeAvatar.onchange = (event)=>{
            const file = inputChangeAvatar.files[0];
