...
@section('content')
    ...
    <div class="page-content-wrapper border">
        ...
        <div class="row">
            <div class="col-12">
                <h1 class="h3 mb-2 mb-sm-0">Список преподавателей</h1>
            </div>
        </div>
                                        ...
                                        <div class="card-header bg-transparent border-bottom d-flex justify-content-between">
                                            <div class="d-sm-flex align-items-center">
                                                ...
                                                <div class="ms-0 ms-sm-2 mt-2 mt-sm-0">
                                                    <h5 class="mb-0"><a href="#">{{$teacher->name}}</a></h5>
                                                    <span class="text-body small"><i class="fas fa-fw fa-map-marker-alt me-1 mt-1"></i>{{$teacher->email}}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="dropdown text-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-w-sm dropdown-menu-end min-w-auto shadow rounded" aria-labelledby="dropdownShare2">
                                                    <li><a data-teacher-id="{{$teacher->id}}" class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fas fa-cog"></i> Назначить курс</a></li>
                                                    <li><a class="dropdown-item" href="/deleteStudent/{{$teacher->id}}"><i class="fas fa-trash-alt"></i> Удалить</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- Card footer -->
                                        <div class="card-footer bg-transparent border-top">
                                            <div class="d-sm-flex justify-content-between align-items-center">
                                                ...
                                                <h6 class="mb-2 mb-sm-0">
                                                    <i class="bi bi-calendar fa-fw text-orange me-2"></i><span class="text-body">Join at:</span> {{$teacher->created_at}}
                                                </h6>
                                                <!-- Buttons -->
            ...
            @section('script')
                <script>
                    ...
                    myModalEl.addEventListener('show.bs.modal', event => {
                        console.log(event.relatedTarget.dataset.teacherId)
                        teacherId = event.relatedTarget.dataset.teacherId;
                        courseList.innerHTML = "";
                        fetch('/getBindTeacherCourse/'+teacherId)
                    ...
                    function addStudentCourse(btn){
                        ...
                        fetch(`/addStudentCourse/${teacherId}/${courseId}`)
                            .then(response=>response.json())
                            .then(result=>{
