                                        ...
                                        <div class="card-header bg-transparent border-bottom d-flex justify-content-between">
                                            <div class="d-sm-flex align-items-center">
                                                ...
                                                <div class="ms-0 ms-sm-2 mt-2 mt-sm-0">
                                                    ...
                                                    <span class="text-body small"><i class="fas fa-fw fa-map-marker-alt me-1 mt-1"></i>{{$user->email}}</span><br>
                                                    <span class="text-body small">Роль: {{$user->role}}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="dropdown text-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-w-sm dropdown-menu-end min-w-auto shadow rounded" aria-labelledby="dropdownShare2">
                                                    <li><a class="dropdown-item" href="/changeUser/{{$user->id}}"><i class="fa-solid fa-user-pen"></i> Редактировать</a></li>
                                                    <li><a class="dropdown-item" href="#"><i class="fa-solid fa-user-xmark"></i> Удалить</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- Card footer -->
                                        <div class="card-footer bg-transparent border-top">
                                            <div class="d-sm-flex justify-content-between align-items-center">
                                                ...
                                                <h6 class="mb-2 mb-sm-0">
                                                    <i class="bi bi-calendar fa-fw text-orange me-2"></i><span class="text-body">Join at:</span> {{$user->created_at}}
                                                </h6>
                                                <!-- Buttons -->
